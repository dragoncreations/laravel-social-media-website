            ...
            <div class="group relative bg-white">
                ...
                <div class="flex">
                    <div class="flex items-center justify-center relative group/avatar -mt-[64px] ml-[48px] w-[128px] h-[128px]">
                        ...
                        <button
                            v-if="!avatarImageSrc"
                            class="absolute left-0 top-0 right-0 bottom-0 bg-black/50 text-gray-200 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100">
            ...
            <div class="border-t">
                <TabGroup>
                    <TabList class="flex bg-white">
                        ...
                        <Tab v-if="authUser && authUser.id == user.id" v-slot="{ selected }" as="template">
