    ...
    <div class="bg-white border rounded p-4 mb-3">
        ...
        <Disclosure v-slot="{ open }">
            <div class="flex gap-2">
                <button
                    @click="sendReaction"
                    class="flex gap-1 items-center justify-center rounded-lg py-2 px-4 flex-1"
                    :class="[
                ...
                <div class="flex gap-2 mb-3">
                    ...
                    <div class="flex flex-1">
                        <InputTextarea v-model="newCommentText" placeholder="Enter your comment here" rows="1" 
                            class="max-h-[160px] w-full resize-none rounded-r-none"></InputTextarea>
                    ...
                    <div v-for="comment of post.comments" :key="comment.id" class="mb-4">
                        ...
                        <div class="pl-12">
                            <div v-if="editingComment && editingComment.id === comment.id">
                                <InputTextarea v-model="editingComment.comment" placeholder="Enter your comment here" rows="1" class="max-h-[160px] w-full resize-none"></InputTextarea>
